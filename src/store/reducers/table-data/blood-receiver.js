...
const reducer = (state = init_state, action) => {
    switch (action.type) {
        case actions.BLOOD_RECEIVING_TABLE_LOAD: return LoadData(state)
        case actions.BLOOD_RECEIVING_TABLE_LOAD_SUCCESS: return loadDataSuccess(state,action)
        case actions.BLOOD_RECEIVING_TABLE_LOAD_FAIL: return loadDataFail(state,action)
        case actions.BLOOD_RECEIVING_TABLE_LOAD_DROPDOWN: return loadAvailBlood(state,action)
        case actions.BLOOD_RECEIVING_TABLE_CHANGE_DROPDOWN: return currentBloodChange(state,action)
        case actions.BLOOD_RECEIVING_TABLE_LOADING: return(setLoading(state))
